...
if (shell.exec(`rollup -c rollup.es.config.js -i ${NPM_DIR}/src/${PACKAGE}.js -o ${ESM2015_DIR}/${PACKAGE}.js`).code !== 0) {
...
if (shell.exec(`rollup -c rollup.es.config.js -i ${OUT_DIR_ESM5}/src/${PACKAGE}.js -o ${ESM5_DIR}/${PACKAGE}.js`).code !== 0) {
